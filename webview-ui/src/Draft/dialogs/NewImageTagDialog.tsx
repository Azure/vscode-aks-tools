...
import { DialogState } from "../../utilities/dialogState";
import { Validatable, hasMessage, invalid, isValid, missing, orDefault, valid } from "../../utilities/validation";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faTimesCircle } from "@fortawesome/free-solid-svg-icons";
import { DraftDialogContentDefinition, DraftDialogEventDef } from "./dialogState";
import { EventHandlers } from "../../utilities/state";

export interface NewImageTagDialogProps {
    state: DialogState<DraftDialogContentDefinition, "newImageTag">;
    existingTags: string[];
...
export function NewImageTagDialog(props: NewImageTagDialogProps) {
    function handleImageTagChange(e: Event | FormEvent<HTMLElement>) {
        ...
        const content = { ...props.state.content, tag: getValidatedImageTag(tag) };
