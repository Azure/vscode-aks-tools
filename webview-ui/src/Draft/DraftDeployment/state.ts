...
import {
    DraftDialogEventDef,
    DraftDialogState,
    getDraftDialogEventHandler,
    initialDraftDialogState,
} from "../dialogs/dialogState";
...
export type DraftDeploymentState = DraftDialogState & {
...
export const stateUpdater: WebviewStateUpdater<"draftDeployment", EventDef, DraftDeploymentState> = {
    ...
    vscodeMessageHandler: {
        ...
        getResourceGroupsResponse: (state, args) => ({
            ...state,
            azureReferenceData: AzureReferenceDataUpdate.updateResourceGroups(
        ...
        getRepoTagsResponse: (state, args) => ({
            ...state,
            azureReferenceData: AzureReferenceDataUpdate.updateAcrRepoTags(
                state.azureReferenceData,
                args.subscriptionId,
                args.resourceGroup,
                args.acrName,
    ...
    eventHandler: {
        ...
        setResourceGroupsLoading: (state, args) => ({
            ...state,
            azureReferenceData: AzureReferenceDataUpdate.setResourceGroupsLoading(
                state.azureReferenceData,
                args.subscriptionId,
            ),
        }),
        setAcrsLoading: (state, args) => ({
            ...state,
            azureReferenceData: AzureReferenceDataUpdate.setAcrsLoading(
                state.azureReferenceData,
                args.subscriptionId,
                args.resourceGroup,
            ),
        ...
        setRepositoriesLoading: (state, args) => ({
            ...state,
            azureReferenceData: AzureReferenceDataUpdate.setAcrRepositoriesLoading(
                state.azureReferenceData,
                args.subscriptionId,
                args.resourceGroup,
                args.acrName,
        ...
        setRepoTagsLoading: (state, args) => ({
            ...state,
            azureReferenceData: AzureReferenceDataUpdate.setAcrRepoTagsLoading(
                state.azureReferenceData,
                args.subscriptionId,
                args.resourceGroup,
                args.acrName,
        ...
        setClusterNamespacesLoading: (state, args) => ({
            ...state,
            azureReferenceData: AzureReferenceDataUpdate.setClusterNamespacesLoading(
                state.azureReferenceData,
                args.subscriptionId,
                args.resourceGroup,
                args.clusterName,
