...
export function getContainerAssistRecommendationsInfoState(): boolean | undefined {
    return vscode.workspace.getConfiguration("aks")["containerAssistEnabledPreview"];
}
