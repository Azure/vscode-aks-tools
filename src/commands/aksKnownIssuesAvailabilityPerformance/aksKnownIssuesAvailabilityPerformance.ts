...
export default async function aksKnownIssuesAvailabilityPerformanceDiagnostics(
...
async function loadDetector(
    ...
    await longRunning(`Loading ${clustername} diagnostics.`,
      async () => {
        const detectorInfo = await getDetectorInfo(cloudTarget, "aks-category-availability-perf");
