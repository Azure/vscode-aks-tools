...
export async function aksDeployManifest() {
    ...
    if (!confirmed) {
        ...
        logGitHubCopilotPluginEvent({ commandId: "aks.aksDeployManifest", deploymentCancelled: "true" });
        return;
    }
    ...
    if (failed(deploymentResult)) {
        ...
        logGitHubCopilotPluginEvent({ commandId: "aks.aksDeployManifest", deploymentSuccess: "false" });
        return;
    }

    logGitHubCopilotPluginEvent({ commandId: "aks.aksDeployManifest", deploymentSuccess: "true" });
